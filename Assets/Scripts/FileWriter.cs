...
public class FileWriter : MonoBehaviour {
    ...
    void FixedUpdate()
    {
        if (!initialFile)
        {
            ...
            if (_tuneGameManager.isSetup)
            {
                ...
                _streamWriter.WriteLine("Block Tower large screen");
    ...
    IEnumerator Delay(int _turnNum)
    {
